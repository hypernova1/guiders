...
public class EssayController {
  ...
  @RequestMapping(value = "/essay/{eno}", method = RequestMethod.PUT, produces = "application/json;charset=utf-8")
  ...
  @GetMapping("essays")
  public @ResponseBody ResponseEntity<List<Map<String, Object>>> getEssays(){
